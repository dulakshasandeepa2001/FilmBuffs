...
const TalkToMePost = () => {
  ...
  // Download links for Talk to Me
  const downloadLinks = {
    '480p x264-mega': 'https://mega.google.com/talk-to-me-480p-x264.mp4',
    '480p x264-viking': 'https://viking.google.com/talk-to-me-480p-x264.mp4',
    '480p x264-gdrive': 'https://drive.google.com/talk-to-me-480p-x264.mp4',
    '480p x265-mega': 'https://mega.google.com/talk-to-me-480p-x265.mp4',
    '480p x265-viking': 'https://viking.google.com/talk-to-me-480p-x265.mp4',
    '480p x265-gdrive': 'https://drive.google.com/talk-to-me-480p-x265.mp4',

    '720p x264-mega': 'https://mega.google.com/talk-to-me-720p-x264.mp4',
    '720p x264-viking': 'https://viking.google.com/talk-to-me-720p-x264.mp4',
    '720p x264-gdrive': 'https://drive.google.com/talk-to-me-720p-x264.mp4',
    '720p x265-mega': 'https://mega.google.com/talk-to-me-720p-x265.mp4',
    '720p x265-viking': 'https://viking.google.com/talk-to-me-720p-x265.mp4',
    '720p x265-gdrive': 'https://drive.google.com/talk-to-me-720p-x265.mp4',

    '1080p x264-mega': 'https://mega.google.com/talk-to-me-1080p-x264.mp4',
    '1080p x264-viking': 'https://viking.google.com/talk-to-me-1080p-x264.mp4',
    '1080p x264-gdrive': 'https://drive.google.com/talk-to-me-1080p-x264.mp4',
    '1080p x265-mega': 'https://mega.google.com/talk-to-me-1080p-x265.mp4',
    '1080p x265-viking': 'https://viking.google.com/talk-to-me-1080p-x265.mp4',
    '1080p x265-gdrive': 'https://drive.google.com/talk-to-me-1080p-x265.mp4',
  };
  ...
  return (
    <div className="movie-post-page">
      <div className="movie-poster-container">
        <img 
          src="https://m.media-amazon.com/images/M/MV5BNDIzMTk4NDYtMjg5OS00ZGI0LWJhZDYtMzJmMWE1YWRlZDJkXkEyXkFqcGdeQXVyMTEzMTI1Mjk3._V1_.jpg" 
          alt="Talk to Me" 
          className="movie-poster-image" 
        />
        
        <div className="movie-content">
          <h1 className="movie-title">Talk to Me</h1>
          <div className="movie-rating">Rating: 7.1/10</div>
          ...
          <div className="download-section">
            ...
            <div className="trailer-section">
              <a 
                href="https://www.youtube.com/watch?v=aLAKJu9aJys" 
                target="_blank" 
          ...
          <div className="movie-info">
            ...
            <div className="movie-details">
              ...
              <div className="detail-item">
                ...
                <span className="value">1h 35m</span>
              </div>
              <div className="detail-item">
                <span className="label">Genre:</span>
                <span className="value">Horror, Thriller</span>
              </div>
              <div className="detail-item">
                <span className="label">Directors:</span>
                <span className="value">Danny Philippou, Michael Philippou</span>
              </div>
            </div>
          </div>
        </div>
