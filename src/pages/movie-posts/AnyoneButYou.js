...
const AnyoneButYouPost = () => {
  ...
  // Download links for Anyone But You
  const downloadLinks = {
    '480p x264-mega': 'https://mega.google.com/anyone-but-you-480p-x264.mp4',
    '480p x264-viking': 'https://viking.google.com/anyone-but-you-480p-x264.mp4',
    '480p x264-gdrive': 'https://drive.google.com/anyone-but-you-480p-x264.mp4',
    '480p x265-mega': 'https://mega.google.com/anyone-but-you-480p-x265.mp4',
    '480p x265-viking': 'https://viking.google.com/anyone-but-you-480p-x265.mp4',
    '480p x265-gdrive': 'https://gdrive.google.com/anyone-but-you-480p-x265.mp4',

    '720p x264-mega': 'https://mega.google.com/anyone-but-you-720p-x264.mp4',
    '720p x264-viking': 'https://viking.google.com/anyone-but-you-720p-x264.mp4',
    '720p x264-gdrive': 'https://drive.google.com/anyone-but-you-720p-x264.mp4',
    '720p x265-mega': 'https://mega.google.com/anyone-but-you-720p-x265.mp4',
    '720p x265-viking': 'https://viking.google.com/anyone-but-you-720p-x265.mp4',
    '720p x265-gdrive': 'https://gdrive.google.com/anyone-but-you-720p-x265.mp4',

    '1080p x264-mega': 'https://mega.google.com/anyone-but-you-1080p-x264.mp4',
    '1080p x264-viking': 'https://viking.google.com/anyone-but-you-1080p-x264.mp4',
    '1080p x264-gdrive': 'https://drive.google.com/anyone-but-you-1080p-x264.mp4',
    '1080p x265-mega': 'https://mega.google.com/anyone-but-you-1080p-x265.mp4',
    '1080p x265-viking': 'https://viking.google.com/anyone-but-you-1080p-x265.mp4',
    '1080p x265-gdrive': 'https://gdrive.google.com/anyone-but-you-1080p-x265.mp4',
  };
  ...
  return (
    <div className="movie-post-page">
      <div className="movie-poster-container">
        <img 
          src="https://m.media-amazon.com/images/I/81mvGTyADRL._UF1000,1000_QL80_.jpg" 
          alt="Anyone But You" 
          className="movie-poster-image" 
        />
        
        <div className="movie-content">
          <h1 className="movie-title">Anyone But You</h1>
          <div className="movie-rating">Rating: 6.1/10</div>
          ...
          <div className="download-section">
            ...
            <div className="trailer-section">
              <a 
                href="https://www.youtube.com/watch?v=Zl28HqPkH00" 
                target="_blank" 
          ...
          <div className="movie-info">
            ...
            <div className="movie-details">
              ...
              <div className="detail-item">
                ...
                <span className="value">1h 43m</span>
              </div>
              <div className="detail-item">
                <span className="label">Genre:</span>
                <span className="value">Comedy, Romance</span>
              </div>
              <div className="detail-item">
                <span className="label">Director:</span>
                <span className="value">Will Gluck</span>
              </div>
            </div>
          </div>
        </div>
...
export default AnyoneButYouPost;
