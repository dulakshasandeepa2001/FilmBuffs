...
const SaltburnPost = () => {
  ...
  // Download links for Saltburn
  const downloadLinks = {
    '480p x264-mega': 'https://mega.google.com/saltburn-480p-x264.mp4',
    '480p x264-viking': 'https://viking.google.com/saltburn-480p-x264.mp4',
    '480p x264-gdrive': 'https://drive.google.com/saltburn-480p-x264.mp4',
    '480p x265-mega': 'https://mega.google.com/saltburn-480p-x265.mp4',
    '480p x265-viking': 'https://viking.google.com/saltburn-480p-x265.mp4',
    '480p x265-gdrive': 'https://drive.google.com/saltburn-480p-x265.mp4',

    '720p x264-mega': 'https://mega.google.com/saltburn-720p-x264.mp4',
    '720p x264-viking': 'https://viking.google.com/saltburn-720p-x264.mp4',
    '720p x264-gdrive': 'https://drive.google.com/saltburn-720p-x264.mp4',
    '720p x265-mega': 'https://mega.google.com/saltburn-720p-x265.mp4',
    '720p x265-viking': 'https://viking.google.com/saltburn-720p-x265.mp4',
    '720p x265-gdrive': 'https://drive.google.com/saltburn-720p-x265.mp4',

    '1080p x264-mega': 'https://mega.google.com/saltburn-1080p-x264.mp4',
    '1080p x264-viking': 'https://viking.google.com/saltburn-1080p-x264.mp4',
    '1080p x264-gdrive': 'https://drive.google.com/saltburn-1080p-x264.mp4',
    '1080p x265-mega': 'https://mega.google.com/saltburn-1080p-x265.mp4',
    '1080p x265-viking': 'https://viking.google.com/saltburn-1080p-x265.mp4',
    '1080p x265-gdrive': 'https://drive.google.com/saltburn-1080p-x265.mp4',
  };
  ...
  return (
    <div className="movie-post-page">
      <div className="movie-poster-container">
        <img 
          src="https://m.media-amazon.com/images/M/MV5BYjU3MmNiZDMtN2Y5NC00ZWRlLWI1OTAtNGI1MDQyNTQwODI0XkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_.jpg" 
          alt="Saltburn" 
          className="movie-poster-image" 
        />
        
        <div className="movie-content">
          <h1 className="movie-title">Saltburn</h1>
          <div className="movie-rating">Rating: 7.0/10</div>
          ...
          <div className="download-section">
            ...
            <div className="trailer-section">
              <a 
                href="https://www.youtube.com/watch?v=nPDH4lZB6HU" 
                target="_blank" 
          ...
          <div className="movie-info">
            ...
            <div className="movie-details">
              ...
              <div className="detail-item">
                ...
                <span className="value">2h 11m</span>
              </div>
              <div className="detail-item">
                <span className="label">Genre:</span>
                <span className="value">Comedy, Drama, Thriller</span>
              </div>
              <div className="detail-item">
                <span className="label">Director:</span>
                <span className="value">Emerald Fennell</span>
              </div>
            </div>
          </div>
        </div>
