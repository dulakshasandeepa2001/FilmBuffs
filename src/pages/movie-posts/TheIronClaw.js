...
const TheIronClawPost = () => {
  ...
  // Download links for The Iron Claw
  const downloadLinks = {
    '480p x264-mega': 'https://mega.google.com/the-iron-claw-480p-x264.mp4',
    '480p x264-viking': 'https://viking.google.com/the-iron-claw-480p-x264.mp4',
    '480p x264-gdrive': 'https://drive.google.com/the-iron-claw-480p-x264.mp4',
    '480p x265-mega': 'https://mega.google.com/the-iron-claw-480p-x265.mp4',
    '480p x265-viking': 'https://viking.google.com/the-iron-claw-480p-x265.mp4',
    '480p x265-gdrive': 'https://drive.google.com/the-iron-claw-480p-x265.mp4',

    '720p x264-mega': 'https://mega.google.com/the-iron-claw-720p-x264.mp4',
    '720p x264-viking': 'https://viking.google.com/the-iron-claw-720p-x264.mp4',
    '720p x264-gdrive': 'https://drive.google.com/the-iron-claw-720p-x264.mp4',
    '720p x265-mega': 'https://mega.google.com/the-iron-claw-720p-x265.mp4',
    '720p x265-viking': 'https://viking.google.com/the-iron-claw-720p-x265.mp4',
    '720p x265-gdrive': 'https://drive.google.com/the-iron-claw-720p-x265.mp4',

    '1080p x264-mega': 'https://mega.google.com/the-iron-claw-1080p-x264.mp4',
    '1080p x264-viking': 'https://viking.google.com/the-iron-claw-1080p-x264.mp4',
    '1080p x264-gdrive': 'https://drive.google.com/the-iron-claw-1080p-x264.mp4',
    '1080p x265-mega': 'https://mega.google.com/the-iron-claw-1080p-x265.mp4',
    '1080p x265-viking': 'https://viking.google.com/the-iron-claw-1080p-x265.mp4',
    '1080p x265-gdrive': 'https://drive.google.com/the-iron-claw-1080p-x265.mp4',
  };
  ...
  return (
    <div className="movie-post-page">
      <div className="movie-poster-container">
        <img 
          src="https://m.media-amazon.com/images/M/MV5BMTU0NDIyMzAtOGFjNS00MTMzLWE0ZGQtZjkwNjJjMzAyNDI4XkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_.jpg" 
          alt="The Iron Claw" 
          className="movie-poster-image" 
        />
        
        <div className="movie-content">
          <h1 className="movie-title">The Iron Claw</h1>
          ...
          <div className="download-section">
            ...
            <div className="trailer-section">
              <a 
                href="https://www.youtube.com/watch?v=BUWJGKt18ZE" 
                target="_blank" 
          ...
          <div className="movie-info">
            ...
            <p>
              The true story of the inseparable Von Erich brothers, who made history in the intensely competitive world of professional wrestling in the early 1980s. Through tragedy and triumph, under the shadow of their domineering father and coach, the brothers seek immortal glory on their terms.
            </p>
            ...
            <div className="movie-details">
              ...
              <div className="detail-item">
                ...
                <span className="value">Biography, Drama, Sport</span>
              </div>
              <div className="detail-item">
                <span className="label">Director:</span>
                <span className="value">Sean Durkin</span>
              </div>
            </div>
          </div>
        </div>
...
export default TheIronClawPost;
