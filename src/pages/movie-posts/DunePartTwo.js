...
const DunePartTwoPost = () => {
  ...
  // Download links for Dune: Part Two
  const downloadLinks = {
    '480p x264-mega': 'https://mega.google.com/dune-part-two-480p-x264.mp4',
    '480p x264-viking': 'https://viking.google.com/dune-part-two-480p-x264.mp4',
    '480p x264-gdrive': 'https://drive.google.com/dune-part-two-480p-x264.mp4',
    '480p x265-mega': 'https://mega.google.com/dune-part-two-480p-x265.mp4',
    '480p x265-viking': 'https://viking.google.com/dune-part-two-480p-x265.mp4',
    '480p x265-gdrive': 'https://drive.google.com/dune-part-two-480p-x265.mp4',

    '720p x264-mega': 'https://mega.google.com/dune-part-two-720p-x264.mp4',
    '720p x264-viking': 'https://viking.google.com/dune-part-two-720p-x264.mp4',
    '720p x264-gdrive': 'https://drive.google.com/dune-part-two-720p-x264.mp4',
    '720p x265-mega': 'https://mega.google.com/dune-part-two-720p-x265.mp4',
    '720p x265-viking': 'https://viking.google.com/dune-part-two-720p-x265.mp4',
    '720p x265-gdrive': 'https://drive.google.com/dune-part-two-720p-x265.mp4',

    '1080p x264-mega': 'https://mega.google.com/dune-part-two-1080p-x264.mp4',
    '1080p x264-viking': 'https://viking.google.com/dune-part-two-1080p-x264.mp4',
    '1080p x264-gdrive': 'https://drive.google.com/dune-part-two-1080p-x264.mp4',
    '1080p x265-mega': 'https://mega.google.com/dune-part-two-1080p-x265.mp4',
    '1080p x265-viking': 'https://viking.google.com/dune-part-two-1080p-x265.mp4',
    '1080p x265-gdrive': 'https://drive.google.com/dune-part-two-1080p-x265.mp4',
  };
    ...
    <div className="movie-post-page">
      <div className="movie-poster-container">
        ...
        <div className="movie-content">
          ...
          <div className="movie-rating">Rating: 8.9/10</div>
          ...
          <div className="movie-info">
            ...
            <div className="movie-details">
              ...
              <div className="detail-item">
                ...
                <span className="value">2h 46m</span>
              </div>
              <div className="detail-item">
                <span className="label">Genre:</span>
                <span className="value">Action, Adventure, Drama, Sci-Fi</span>
              </div>
              <div className="detail-item">
                <span className="label">Director:</span>
                <span className="value">Denis Villeneuve</span>
              </div>
            </div>
          </div>
        </div>
...
export default DunePartTwoPost;
